...
namespace mitk
{
	...
	*/
	class RegionGrowingTool : public mitk::Tool
	{
		public:
			 ...
			 */
			mitkClassMacro(RegionGrowingTool, mitk::Tool);	    
			/**
		...
		protected:
			RegionGrowingTool(); // purposely hidden, should always be done with itk::Objects that are create by New()
			~RegionGrowingTool();
			/**
