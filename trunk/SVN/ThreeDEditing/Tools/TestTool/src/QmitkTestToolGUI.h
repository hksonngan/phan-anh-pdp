...
#ifndef QmitkTestToolGUI_h_Included
#define QmitkTestToolGUI_h_Included
...
class QmitkTestToolGUI : public QmitkToolGUI
{
	Q_OBJECT
	public:
		/**
		...
		*/
		mitkClassMacro(QmitkTestToolGUI, QmitkToolGUI);
		/**
		...
		*/
		itkNewMacro(QmitkTestToolGUI);
		virtual ~QmitkTestToolGUI();
	signals:
	public slots:
	...
	protected slots:
	protected:
		QPushButton* m_StartAuswertung;
		QPushButton* m_ConvertData;
		QPushButton* m_Closing;
		QPushButton* m_AuswertungPixel;

		// Tool specific
		QmitkTestToolGUI();
		mitk::TestTool::Pointer m_TestTool;
};
