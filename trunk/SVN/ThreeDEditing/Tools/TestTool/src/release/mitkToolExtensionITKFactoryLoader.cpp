...
#include <mitkTestToolFactory.h>
#include <QmitkTestToolGUIFactory.h>
...
class mitkToolExtensionITKFactoryLoader : public ::itk::ObjectFactoryBase
{
  ...
  protected:
    ...
    mitkToolExtensionITKFactoryLoader()
    {
      ...
      // the shared library
	  itk::ObjectFactoryBase::RegisterFactory(mitk::TestToolFactory::New());
	  itk::ObjectFactoryBase::RegisterFactory(QmitkTestToolGUIFactory::New());
    }
