...
#include <mitkRegistrationToolFactory.h>
#include <QmitkRegistrationToolGUIFactory.h>
...
class mitkToolExtensionITKFactoryLoader : public ::itk::ObjectFactoryBase
{
  ...
  protected:
    ...
    mitkToolExtensionITKFactoryLoader()
    {
      ...
      // the shared library
	  itk::ObjectFactoryBase::RegisterFactory(mitk::RegistrationToolFactory::New());
	  itk::ObjectFactoryBase::RegisterFactory(QmitkRegistrationToolGUIFactory::New());
    }
