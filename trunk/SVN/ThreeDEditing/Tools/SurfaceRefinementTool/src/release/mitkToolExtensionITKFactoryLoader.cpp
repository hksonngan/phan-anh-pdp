...
#include <mitkSurfaceRefinementToolFactory.h>
#include <QmitkSurfaceRefinementToolGUIFactory.h>
...
class mitkToolExtensionITKFactoryLoader : public ::itk::ObjectFactoryBase
{
  ...
  protected:
    ...
    mitkToolExtensionITKFactoryLoader()
    {
      ...
      // the shared library
	  itk::ObjectFactoryBase::RegisterFactory(mitk::SurfaceRefinementToolFactory::New());
	  itk::ObjectFactoryBase::RegisterFactory(QmitkSurfaceRefinementToolGUIFactory::New());
    }
