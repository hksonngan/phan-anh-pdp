...
#include <mitkMoveROIToolFactory.h>
#include <QmitkMoveROIToolGUIFactory.h>
...
class mitkToolExtensionITKFactoryLoader : public ::itk::ObjectFactoryBase
{
  ...
  protected:
    ...
    mitkToolExtensionITKFactoryLoader()
    {
      ...
      // the shared library
      itk::ObjectFactoryBase::RegisterFactory(mitk::MoveROIToolFactory::New());
	  itk::ObjectFactoryBase::RegisterFactory(QmitkMoveROIToolGUIFactory::New());
    }
