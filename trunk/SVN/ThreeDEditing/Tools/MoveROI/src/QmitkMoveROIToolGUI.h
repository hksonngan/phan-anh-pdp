...
#ifndef QmitkMoveROIToolGUI_h_Included
#define QmitkMoveROIToolGUI_h_Included
...
class QmitkMoveROIToolGUI : public QmitkToolGUI
{
  Q_OBJECT
  ...
  public:
     ...
     */
    mitkClassMacro(QmitkMoveROIToolGUI, QmitkToolGUI);
     ...
     */
    itkNewMacro(QmitkMoveROIToolGUI);
    
    virtual ~QmitkMoveROIToolGUI();
  ...
  protected:
	...
	mitk::MoveROITool::Pointer m_MoveROITool;
