...
#include <mitkFillHoleToolFactory.h>
#include <QmitkFillHoleToolGUIFactory.h>
...
class mitkToolExtensionITKFactoryLoader : public ::itk::ObjectFactoryBase
{
  ...
  protected:
    ...
    mitkToolExtensionITKFactoryLoader()
    {
      ...
      // the shared library
	  itk::ObjectFactoryBase::RegisterFactory(mitk::FillHoleToolFactory::New());
	  itk::ObjectFactoryBase::RegisterFactory(QmitkFillHoleToolGUIFactory::New());
    }
