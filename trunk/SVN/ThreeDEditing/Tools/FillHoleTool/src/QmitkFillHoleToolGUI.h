...
#ifndef QmitkFillHoleToolGUI_h_Included
#define QmitkFillHoleToolGUI_h_Included
...
class QmitkFillHoleToolGUI : public QmitkToolGUI
{
	Q_OBJECT
	public:
		/**
		...
		*/
		mitkClassMacro(QmitkFillHoleToolGUI, QmitkToolGUI);
		/**
		...
		*/
		itkNewMacro(QmitkFillHoleToolGUI);
		virtual ~QmitkFillHoleToolGUI();
	signals:
	public slots:
	...
	protected:
		...
		mitk::FillHoleTool::Pointer m_FillHoleTool;
};
