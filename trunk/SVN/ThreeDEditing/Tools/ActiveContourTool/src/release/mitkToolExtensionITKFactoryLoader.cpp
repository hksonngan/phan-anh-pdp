...
#include <mitkActiveContourToolFactory.h>
#include <QmitkActiveContourToolGUIFactory.h>
...
class mitkToolExtensionITKFactoryLoader : public ::itk::ObjectFactoryBase
{
  ...
  protected:
    ...
    mitkToolExtensionITKFactoryLoader()
    {
      ...
      // the shared library
	  itk::ObjectFactoryBase::RegisterFactory(mitk::ActiveContourToolFactory::New());
	  itk::ObjectFactoryBase::RegisterFactory(QmitkActiveContourToolGUIFactory::New());
    }
