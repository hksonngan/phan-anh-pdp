...
#include <mitkCutToolFactory.h>
#include <QmitkCutToolGUIFactory.h>
...
class mitkToolExtensionITKFactoryLoader : public ::itk::ObjectFactoryBase
{
  ...
  protected:
    ...
    mitkToolExtensionITKFactoryLoader()
    {
      ...
      // the shared library
	  itk::ObjectFactoryBase::RegisterFactory(mitk::CutToolFactory::New());
	  itk::ObjectFactoryBase::RegisterFactory(QmitkCutToolGUIFactory::New());
    }
