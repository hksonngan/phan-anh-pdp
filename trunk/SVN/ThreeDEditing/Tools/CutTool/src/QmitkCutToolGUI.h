...
#ifndef QmitkCutToolGUI_h_Included
#define QmitkCutToolGUI_h_Included
...
class QmitkCutToolGUI : public QmitkToolGUI
{
	Q_OBJECT
	public:
		/**
		...
		*/
		mitkClassMacro(QmitkCutToolGUI, QmitkToolGUI);
		/**
		...
		*/
		itkNewMacro(QmitkCutToolGUI);
		virtual ~QmitkCutToolGUI();
	signals:
	public slots:
	...
	protected:
		...
		// Tool specific
		QmitkCutToolGUI();
		mitk::CutTool::Pointer m_CutTool;
};
