...
#ifndef mitkSmoothTool_h_Included
#define mitkSmoothTool_h_Included
...
namespace mitk
{
	...
	*/
	class SmoothTool : public mitk::Tool
	{
		public:
		...
		protected:
			SmoothTool(); // purposely hidden, should always be done with itk::Objects that are create by New()
			~SmoothTool();
			/**
