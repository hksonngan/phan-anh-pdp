...
#include <mitkSmoothToolFactory.h>
#include <QmitkSmoothToolGUIFactory.h>
...
class mitkToolExtensionITKFactoryLoader : public ::itk::ObjectFactoryBase
{
  ...
  protected:
    ...
    mitkToolExtensionITKFactoryLoader()
    {
      ...
      // the shared library
	  itk::ObjectFactoryBase::RegisterFactory(mitk::SmoothToolFactory::New());
	  itk::ObjectFactoryBase::RegisterFactory(QmitkSmoothToolGUIFactory::New());
    }
