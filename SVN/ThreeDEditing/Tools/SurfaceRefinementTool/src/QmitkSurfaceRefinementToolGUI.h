...
#ifndef QmitkSurfaceRefinementToolGUI_h_Included
#define QmitkSurfaceRefinementToolGUI_h_Included
...
class QmitkSurfaceRefinementToolGUI : public QmitkToolGUI
{
	Q_OBJECT
	public:
		/**
		...
		*/
		mitkClassMacro(QmitkSurfaceRefinementToolGUI, QmitkToolGUI);
		/**
		...
		*/
		itkNewMacro(QmitkSurfaceRefinementToolGUI);
		virtual ~QmitkSurfaceRefinementToolGUI();
	signals:
	public slots:
		...
		void ToogleSelectButton();
		void ToogleDeselectButton();
	...
	protected:
		...
		mitk::SurfaceRefinementTool::Pointer m_SurfaceRefinementTool;
		QComboBox* m_SelectRefinementMethodeBox;
		QComboBox* m_SelectRefinementMethodeBoxROI;
		QPushButton* m_PbtnSelectCells;
		QPushButton* m_PbtnDeselectCells;
		QPushButton* m_PbtnSelectAllCells;
		QPushButton* m_PbtnDeselectAllCells;
};
