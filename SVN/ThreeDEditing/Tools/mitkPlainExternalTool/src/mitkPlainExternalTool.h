...
#ifndef mitkPlainExternalTool_h_Included
#define mitkPlainExternalTool_h_Included
...
*/
class PlainExternalTool : public FeedbackContourTool
{
  public:
  ...
  protected:
    ...
    PlainExternalTool(); // purposely hidden, should always be done with itk::Objects that are create by New()
    virtual ~PlainExternalTool();
