...
#include <mitkBulgeToolFactory.h>
#include <QmitkBulgeToolGUIFactory.h>
...
class mitkToolExtensionITKFactoryLoader : public ::itk::ObjectFactoryBase
{
  ...
  protected:
    ...
    mitkToolExtensionITKFactoryLoader()
    {
      ...
      // the shared library
	  itk::ObjectFactoryBase::RegisterFactory(mitk::BulgeToolFactory::New());
	  itk::ObjectFactoryBase::RegisterFactory(QmitkBulgeToolGUIFactory::New());
    }
