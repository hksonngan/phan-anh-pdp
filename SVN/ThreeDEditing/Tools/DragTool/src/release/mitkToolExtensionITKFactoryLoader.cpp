...
#include <mitkDragToolFactory.h>
#include <QmitkDragToolGUIFactory.h>
...
class mitkToolExtensionITKFactoryLoader : public ::itk::ObjectFactoryBase
{
  ...
  protected:
    ...
    mitkToolExtensionITKFactoryLoader()
    {
      ...
      // the shared library
	  itk::ObjectFactoryBase::RegisterFactory(mitk::DragToolFactory::New());
	  itk::ObjectFactoryBase::RegisterFactory(QmitkDragToolGUIFactory::New());
    }
