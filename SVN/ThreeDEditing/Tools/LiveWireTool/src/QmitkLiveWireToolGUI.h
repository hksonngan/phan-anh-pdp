...
#ifndef QmitkLiveWireToolGUI_h_Included
#define QmitkLiveWireToolGUI_h_Included
...
class QmitkLiveWireToolGUI : public QmitkToolGUI
{
	Q_OBJECT
	public:
		/**
		...
		*/
		mitkClassMacro(QmitkLiveWireToolGUI, QmitkToolGUI);
		/**
		...
		*/
		itkNewMacro(QmitkLiveWireToolGUI);
		virtual ~QmitkLiveWireToolGUI();
	signals:
	public slots:
	...
	protected:
		...
		mitk::LiveWireTool::Pointer m_LiveWireTool;
