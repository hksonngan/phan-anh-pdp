...
#include <mitkLiveWireToolFactory.h>
#include <QmitkLiveWireToolGUIFactory.h>
...
class mitkToolExtensionITKFactoryLoader : public ::itk::ObjectFactoryBase
{
  ...
  protected:
    ...
    mitkToolExtensionITKFactoryLoader()
    {
      ...
      // the shared library
	  itk::ObjectFactoryBase::RegisterFactory(mitk::LiveWireToolFactory::New());
	  itk::ObjectFactoryBase::RegisterFactory(QmitkLiveWireToolGUIFactory::New());
    }
