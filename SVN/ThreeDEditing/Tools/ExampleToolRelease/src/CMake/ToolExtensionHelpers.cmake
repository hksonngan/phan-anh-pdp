MACRO(MITK_GENERATE_TOOLS_LIBRARY)
  ...
  IF (TOOL_FILES)
    ...
    FOREACH( TOOL_FILE ${TOOL_FILES}  )
      ...
      CONFIGURE_FILE( ${MITK_SOURCE_DIR}/CMake/ToolExtensionITKFactory.cpp.in  #MITK_DIR
...
${FACTORY_INCLUDE_LINES}" )
  ...
  IF (TOOL_QT3GUI_FILES OR TOOL_QT4GUI_FILES)
    ...
    FOREACH( TOOL_GUI_FILE ${TOOL_QT3GUI_FILES} ${TOOL_QT4GUI_FILES})  
      ...
      CONFIGURE_FILE( ${MITK_SOURCE_DIR}/CMake/ToolGUIExtensionITKFactory.cpp.in #${MITK_DIR}
...
${FACTORY_INCLUDE_LINES}" )
  ...
  IF (TOOL_FILES OR TOOL_QT3GUI_FILES OR TOOL_QT4GUI_FILES)
    IF (libraryname AND reallycreatelibrary)
      ...
      CONFIGURE_FILE( ${MITK_SOURCE_DIR}/CMake/ToolExtensionITKFactoryLoader.cpp.in #MITK_DIR
    ...
    LINK_DIRECTORIES( ${MITK_LINK_DIRECTORIES} ${ALL_LIBDIRS})
    ADD_LIBRARY(${libraryname} SHARED ${TOOL_CPPS} ${TOOL_GUI_CPPS})
    
    TARGET_LINK_LIBRARIES(${libraryname} ${QMITK_LIBRARIES} ${ALL_LIBRARIES})
