...
#ifndef QmitkSmoothToolGUI_h_Included
#define QmitkSmoothToolGUI_h_Included
...
class QmitkSmoothToolGUI : public QmitkToolGUI
{
	Q_OBJECT
	public:
		/**
		...
		*/
		mitkClassMacro(QmitkSmoothToolGUI, QmitkToolGUI);
		/**
		...
		*/
		itkNewMacro(QmitkSmoothToolGUI);
		virtual ~QmitkSmoothToolGUI();
	signals:
	public slots:
	...
	protected:		
		...
		// Tool specific
		QmitkSmoothToolGUI();
		mitk::SmoothTool::Pointer m_SmoothTool;
};
